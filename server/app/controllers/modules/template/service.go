...
func (t *templateService) CreateTemplate(params *types.CreateTemplateRequestParams) (*types.CreateTemplateResponse, error) {
	...
	templates := map[string]string{
		...
		"dto":                "template/server/dto/types.tmpl",
	...
	return &types.CreateTemplateResponse{
...
func (t *templateService) DownloadTemplateZip(params *types.DownloadTemplateRequestParams) ([]byte, error) {
	// 定义文件路径和内容的映射
