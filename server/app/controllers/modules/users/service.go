...
func (u *userService) GetUser(id string) (*types.UsersSingleResponse, error) {
	return repositories.UserRepositorysModules.GetUser(id)
}

func (u *userService) GetUsers(page types.Page) ([]types.UsersSingleResponse, error) {
	return repositories.UserRepositorysModules.GetUsers(page)
}

func (u *userService) CreateUser(user *types.CreateSingleUserRequest) error {
...
func (u *userService) FindUserById(id string) (*types.UsersSingleResponse, bool) {
	return repositories.UserRepositorysModules.FindUserById(id)
}

func (u *userService) FindUserByParams(params *types.QueryUsersParams) (*types.HasTotalResponseData, error) {
	return repositories.UserRepositorysModules.FindUserByParams(params)
}
func (u *userService) FindUserByParamsAndOutRoleID(id string, params *types.QueryUsersParams) (*types.HasTotalResponseData, error) {
	return repositories.UserRepositorysModules.FindUserByParamsAndOutRoleID(id, params)
}

func (u *userService) UpdateUser(params *types.UpdateUserRequest, id string) error {
...
func (u *userService) FindUserByAccount(account string) (*types.SingleUserResponseHasPassword, bool) {
	return repositories.UserRepositorysModules.FindUserByAccount(account)
}

func (u *userService) GetUserByRoleID(roleID string, params types.Page) (*types.HasTotalResponseData, error) {
	if err := UserAndRolesService.FindRoleById(roleID); err != nil {
		return nil, err
	}
	return repositories.UserRepositorysModules.GetUserByRoleID(roleID, params)
}

func (u *userService) ExportExcel(IDs *types.ExportExcelResponse) ([]*types.UsersSingleResponse, error) {
