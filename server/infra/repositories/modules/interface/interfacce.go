...
func (i *interfaceRepository) CreateInterface(params *types.CreateInterfaceRequest) error {
...
func (i *interfaceRepository) GetAllInterface() ([]*types.AllInterfaceResponse, error) {
	query := `
			SELECT
				JSON_OBJECT(
						'key', p.page_name,
	...
	var interfaceResponses []*types.AllInterfaceResponse
	for rows.Next() {
		var interfaceResponse string
		var interfaceUnmarshalResponse *types.AllInterfaceResponse
...
func (i *interfaceRepository) GetInterfaceByID(id string) (inter *types.GetInterfaceResponse, exist bool) {
...
func (i *interfaceRepository) UpdateInterfaceByID(id string, params *types.UpdateInterfaceRequest) error {
