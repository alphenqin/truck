...
func (p *pageRepository) CreatePage(params *types.CreatePageParams) error {
	var err error
	pageID := utils.GenID()
...
func (p *pageRepository) FindPageByID(id string) (*types.SinglePageResponse, error) {
...
func (p *pageRepository) GetPages() ([]*types.SinglePageResponse, error) {
...
func (p *pageRepository) UpdatePage(id string, params *types.UpdatePageRequest) error {
