...
func (r *rolesRepository) CreateRole(role *types.CreateRoleParams) int64 {
...
func (r *rolesRepository) UpdateRole(role *types.UpdateRoleParams, id string) error {
...
func (r *rolesRepository) GetRoles(params *types.QueryRolesParams) (*types.HasTotalResponseData, error) {
	...
	roles := make([]*types.SingleRoleResponse, 0)
	for rows.Next() {
...
func (r *rolesRepository) FindRoleById(id string) *types.SingleRoleResponse {
